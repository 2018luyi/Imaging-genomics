...
#### Methods involving genetic and/or imaging data
- [A review of multivariate analyses in imaging genetics (Calhoun)](https://www.ncbi.nlm.nih.gov/pubmed/24723883).
...
- [Joint sparse canonical correlation analysis for detecting differential imaging genetics modules](https://www.ncbi.nlm.nih.gov/pubmed/27466625).
- [A three-way parallel ICA approach to analyze links among genetics, brain structure and brain function](https://www.ncbi.nlm.nih.gov/pubmed/24795156).
- [Detection of relationships among multi-modal brain imaging meta-features via information flow.](https://www.ncbi.nlm.nih.gov/pubmed/29146193)
- [Latent Representation Learning for Alzheimer's Disease Diagnosis with Incomplete Multi-modality Neuroimaging and Genetic Data](https://www.ncbi.nlm.nih.gov/pubmed/31021792)

#### Applications in cardiac imaging genetics
...
- [Atlas of the clinical genetics of human dilated cardiomyopathy.](https://www.ncbi.nlm.nih.gov/pubmed/25163546)
...
- [Quantitative CMR population imaging on 20,000 subjects of the UK Biobank imaging study: LV/RV quantification pipeline and its evaluation. (Rahman Attar et al.)](https://www.ncbi.nlm.nih.gov/pubmed/31154149)
- [Automated cardiovascular magnetic resonance image analysis with fully convolutional networks (Wenjia Bai et al.)](https://arxiv.org/abs/1710.09289) 
- [UK Biobank, big data, and the consequences of non-representativeness](https://www.ncbi.nlm.nih.gov/pubmed/30938313)
...
- [The C-Word: Scientific Euphemisms Do Not Improve Causal Inference From Observational Data](https://www.ncbi.nlm.nih.gov/pubmed/29565659).
...
#### Videos
- Kayhan Batmanghelich's talk at CGWI (2018): [Imaging as High-Dimensional Endophenotype](https://www.youtube.com/watch?v=pM4PoND41j0)

#### Courses, tutorials and other learning resources
- [Stanford course on Computer Vision.](http://cs231n.stanford.edu/)
- [Tensor hierarchical decomposition](https://web.cs.ucla.edu/~maov/cvpr2019tutorial): Ideas on how to obtain a latent base endowed with a hierarchy.
- [Atlas of Cardiac Genetic Variation](https://www.cardiodb.org/acgv/)
- [Le Zhang's PhD thesis](https://drive.google.com/file/d/1xZhOxeHFgd8upVPPDpFnXPZltmhJekza/view)
